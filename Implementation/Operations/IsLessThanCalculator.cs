...
{
	public class IsLessThanCalculator : BaseOperationCalculator
	{
		...
		{
			var result = milpManager.Operation<IsGreaterThan>(arguments[1], arguments[0]);
		...
		protected override Type[] SupportedTypes => new[] {typeof (IsLessThan)};
	}
}
