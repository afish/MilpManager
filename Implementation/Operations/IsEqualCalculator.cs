...
{
	public class IsEqualCalculator : BaseOperationCalculator
	{
		...
		{
			var result = milpManager.Operation<IsNotEqual>(arguments).Operation<BinaryNegation>();
		...
		protected override Type[] SupportedTypes => new[] {typeof (IsEqual)};
	}
}
